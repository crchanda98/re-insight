...
for _, idf_parent in df_hybrid.iterrows():
    try:
        ...
        df_hybrid = []
        print(f"Running aggrigator for {idf_parent['plant_name']}")
        ...
        db_con.logging({"script": SCRIPT_NAME, "log_type": "success", "message": f"Pushed aggregated data for {farm_name}"})
