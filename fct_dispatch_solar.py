...
for _, idf in df_static.iterrows():
    try:
        ...
        fct_filename = f"../data_lake/re_insights/fct_dispatch/intraday_solar_{farm_name}_{date_now.strftime('%Y%m%d_%H%M')}.csv"
        fct_data = db_con.get_fct_data(plant=farm_name, fct_src="inhouse", model_name="intraday_solar_rf", \
